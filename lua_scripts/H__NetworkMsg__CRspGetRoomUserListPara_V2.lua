CRspGetRoomUserListPara_V2={}

function CRspGetRoomUserListPara_V2.Decode(szBuffer)
	...
	t.m_ucSendFlag=DataParse.NetworkToHostOrderToByte(szBuffer,iStartLength)   --分包标志 0  发完     1 后面还有包
	iStartLength=iStartLength+NetworkDefine.DataType.Byte
