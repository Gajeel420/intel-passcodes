CRspQueryRechargeListPara={}


 function CRspQueryRechargeListPara.Decode(szBuffer)  --解码
	...
	t.m_usRspUserCount=DataParse.NetworkToHostOrderToInt16(szBuffer,iStartLength)
	iStartLength=iStartLength+NetworkDefine.DataType.Int16
	t.m_RspUserList={}
	if t.m_usRspUserCount>0 then
		for i=1,t.m_usRspUserCount do
		    ...
		    t.m_RspUserList[i].m_szNickName=DataParse.BytesToString2(szBuffer,iStartLength,t.m_RspUserList[i].m_ucNickLen)
			iStartLength=iStartLength+t.m_RspUserList[i].m_ucNickLen;--//昵称
