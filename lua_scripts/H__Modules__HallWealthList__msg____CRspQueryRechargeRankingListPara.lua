CRspQueryRechargeRankingListPara={}


 function CRspQueryRechargeRankingListPara.Decode(szBuffer)  --解码
	...
	if t.m_usRspUserCount>0 then
		for i=1,t.m_usRspUserCount do
			...
			t.m_RspUserList[i].m_un64Amount = DataParse.NetworkToHostOrderToInt64(szBuffer,iStartLength)
			iStartLength=iStartLength+NetworkDefine.DataType.Int64; --// 充值数(人民币)
		end
	end
	return t
 end